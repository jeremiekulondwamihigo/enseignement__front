        ...
        <React.Fragment>
            ...
            <Switch>
                ...
                <PrivateRoute path="/" exact
                    component={Main}/>
                <PrivateRoute path="/parametre" exact
                    component={Parameters}/>
                <PrivateRoute path="/ecole" exact
                    component={Tab_Ecole}/>
                <PrivateRoute path="/detail" exact
                    component={Index_Detail}/> {/* SECTEUR */}
                <PrivateRoute path="/parametre_secteur" exact
                    component={Parameters_Secteur}/> {/* ETABLISSEMENT */}
                <PrivateRoute path="/enseignant" exact
                    component={EnsEnseignant}/>
                <PrivateRoute path="/eleve" exact
                    component={PageEleve}/> {/* DIVISION */}
                <PrivateRoute path="/ecoledivision" exact
                    component={IndexDivision}/>
                <PrivateRoute path="/information" exact
                    component={DetailEcole}/>
                <PrivateRoute path="/parametredivision" exact
