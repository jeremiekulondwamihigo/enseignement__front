...
import ComboAutocomplete from '../../utils/Autocomplete'
      ...
      <Paper elevation={1}>
        ...
        <FormControl fullWidth sx={{ m: 1 }} variant="filled">
          <TextField
            ...
            variant="outlined"
            name="phone_agent"
            value={values.phone_agent}
            onChange={(e) => handleChange(e)}
          />
        </FormControl>
        <Box>
          <Button
            onClick={data ? (e) => updatingEcole(e) : (e) => SubmitData(e)}
            color="primary"
            variant="outlined"
            sx={{ m: 1, width: '25ch' }}
          >
