...
import {isEmpty, lien_delete, lien_read, lien_update} from "../../../Static/Liens"
...
function Tab_Annee() {
    ...
    const updateYear = (id, valeur) => {
        axios.put(`${lien_update}/updateyear`, {
            id,
            valeur
    ...
    const columns = [
        {
            ...
            renderCell: (params) => {
                return (
                    <span>{
                        (new Date(params.row.id).toLocaleDateString()).toString()
                    }</span>
                )
            }
        },
            ...
            renderCell: (params) => {
                return (
                    ...
                    <span style={
                        ...
                        <Fab size='small'
                            onClick={
                                () => updateYear(params.row._id, !params.row.active)
                        }>
                            {
                            params.row.active ? <Done style={
                                {
                                    color: "blue",
                                    cursor: "pointer"
                                }
