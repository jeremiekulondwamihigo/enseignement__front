...
import { isEmpty, lien_read, lien_image_admin } from "../Static/Liens"
            ...
            <div className="top">
                ...
                </div>
                {
                    ...
                    <div className="profile">
                        <div className="info">
                            <p>Hey, <b>{data[0].agent[0].nom}</b></p>
                            <small className="text-muted">{!isEmpty(yearSelect.year_actif) && yearSelect.year_actif.annee}</small>
                        </div>
                        <div className="profile-photo">
                            <img src={`${lien_image_admin}/${data[0].agent[0].filename}`} alt="" onClick={(e)=>logOut(e)}/>
                        </div>
                    </div>
                }
