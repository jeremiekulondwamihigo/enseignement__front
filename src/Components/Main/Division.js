...
import AddEcole from '../Division/Form/AddEcole'
import Popup from '../Static/Popup'
import ProtoType from "prop-types"

function Division({ dataLog }) {
  ...
  return (
   <>
        ...
        <div className="sales-analytics">
            ...
            <div className="item add-product" onClick={()=>setOpenPopup(true)} style={{cursor:"pointer"}}>
                <div>
    ...
    <Popup openPopup={openPopup} setOpenPopup={setOpenPopup} title="Ajouter une établissement">
